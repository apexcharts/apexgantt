import { c as commonjsGlobal, _ as _typeof$1, g as getDefaultExportFromCjs } from "./index-BWP5PfTm.js";
...
var ordinaryToPrimitive$1 = function(input, pref) {
  var fn, val;
  if (pref === "string" && isCallable$g(fn = input.toString) && !isObject$9(val = call$g(fn, input)))
    return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$9(val = call$g(fn, input)))
    return val;
  if (pref !== "string" && isCallable$g(fn = input.toString) && !isObject$9(val = call$g(fn, input)))
    return val;
...
var toPrimitive$2 = function(input, pref) {
  if (!isObject$8(input) || isSymbol$1(input))
    return input;
  ...
  if (exoticToPrim) {
    ...
    if (!isObject$8(result) || isSymbol$1(result))
      return result;
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$9 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O2, P) {
  ...
  if (hasOwn$9(O2, P))
    return createPropertyDescriptor$2(!call$e(propertyIsEnumerableModule.f, O2, P), O2[P]);
};
...
var getIterator$1 = function(argument, usingIterator) {
  ...
  if (aCallable$3(iteratorMethod))
    return anObject$b(call$b(iteratorMethod, argument));
    ...
    function(string, replaceValue) {
      ...
      for (var i2 = 0; i2 < results.length; i2++) {
        ...
        if (functionalReplace) {
          ...
          replacement2 = toString$5(apply$1(replaceValue, void 0, replacerArgs));
        } else {
